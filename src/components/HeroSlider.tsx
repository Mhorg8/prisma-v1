            ...
            >
                <SwiperSlide>
                    <div className="w-full h-full relative">
                        <Image src={'/hero-3.jpg'} alt="hero" fill sizes="fill"
                    ...
                    <div className="absolute bottom-[10%] right-[10%] text-start">
                        ...
                        <p className="text-white">ما با بیشترین تنوع در اینترنت این امکان رو برای شما فراهم کردیم که
                            راحتر انتخاب کنید.</p>
                        <SecondaryButton text="اطلاعات بیشتر" path="/" bgColor=""
                                         customStyle="w-fit mt-4  text-sm"/>
                ...
                <SwiperSlide>
                    <div className="w-full h-full relative">
                        <Image src={'/hero-2.jpg'} alt="hero" fill sizes="fill"
                               className="object-cover select-none rounded-xl"/>
                    </div>
                    {/*    text content*/
                    }
                ...
                <SwiperSlide>
                    <div className="w-full h-full relative ">
                        <Image src={'/hero-1.jpg'} alt="hero" fill sizes="fill"
                               className="object-cover select-none rounded-xl"/>
                    </div>
                    {/*    text content*/
                    }
                    <div className="absolute bottom-[10%] right-[10%] text-start ">
                        <h1 className="text-5xl font-bold leading-relaxed select-none text-Sky-blue">ترندترین آیتم
                            ها.</h1>
                        <p className="text-black font-semibold bg-white/50 py-1 px-2">ترندترین آتیم ها در سراسر اینترنت
                            را برای شما فراهم
                            کردیم</p>
                        <SecondaryButton text="اطلاعات بیشتر" path="/" bgColor="" customStyle="w-fit mt-4  text-sm"/>
